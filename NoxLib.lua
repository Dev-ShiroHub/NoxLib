...
function NoxLib:CreateWindow(config)
	...
	local defaultSize = UDim2.new(0, 620, 0, 420)
	...
	btnHolder.Size = UDim2.new(0, 110, 1, 0)
	btnHolder.Position = UDim2.new(0, 8, 0, 0)
	...
	local function circleButton(color, order)
		...
		b.MouseEnter:Connect(function()
			tween(b, 0.12, { Size = UDim2.new(0, 16, 0, 16) })
		end)
		b.MouseLeave:Connect(function()
			tween(b, 0.12, { Size = UDim2.new(0, 14, 0, 14) })
		end)
		return b
	end

	local resizeBtn = circleButton(Theme.Good, 1)
	local maximizeBtn = circleButton(Color3.fromRGB(235, 190, 70), 2)
	local closeBtn = circleButton(Color3.fromRGB(120, 120, 130), 3)
	local destroyBtn = circleButton(Theme.Danger, 4)

	local titleHolder = Instance.new("Frame")
	titleHolder.BackgroundTransparency = 1
	titleHolder.Size = UDim2.new(1, -240, 1, 0)
	titleHolder.Position = UDim2.new(0, 130, 0, 0)
	...
	Content.Size = UDim2.new(1, -176, 1, -12)
	...
	Sidebar.Size = UDim2.new(0, 160, 1, -12)
	Sidebar.Position = UDim2.new(1, -168, 0, 4)
	Sidebar.Parent = Body
	corner(Sidebar, 10)
	...
	openImg.Size = UDim2.new(0, 30, 0, 30)
	openImg.Position = UDim2.new(0, 8, 0.5, -15)
	...
	openText.Size = UDim2.new(1, -50, 1, 0)
	openText.Position = UDim2.new(0, 46, 0, 0)
	openText.Font = Enum.Font.GothamBold
	openText.Text = toggleText
	openText.TextColor3 = Theme.Text
	...
	local minSize = Vector2.new(460, 320)
	local maxSize = Vector2.new(1100, 720)

	resizeBtn.MouseButton1Click:Connect(function()
		resizeEnabled = not resizeEnabled
		resizeHandle.Visible = resizeEnabled
		tween(resizeBtn, 0.12, { BackgroundColor3 = resizeEnabled and Theme.Accent or Theme.Good })
	end)
	...
	maximizeBtn.MouseButton1Click:Connect(function()
		if not maximized then
			...
			tween(Main, 0.25, {
				...
				Position = UDim2.new(0.5, -maxSize.X / 2, 0.5, -maxSize.Y / 2),
			})
			maximized = true
		else
